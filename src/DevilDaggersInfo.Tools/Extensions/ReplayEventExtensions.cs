...
public static class ReplayEventExtensions
{
	...
	public static EventType GetEventType(this EditorEvent editorEvent)
	{
		return editorEvent.Data switch
		{
			BoidSpawnEventData => EventType.BoidSpawn,
			LeviathanSpawnEventData => EventType.LeviathanSpawn,
			PedeSpawnEventData => EventType.PedeSpawn,
			...
			_ => throw new UnreachableException($"Unknown event type '{editorEvent.Data.GetType().Name}'."),
		};
	}
}
