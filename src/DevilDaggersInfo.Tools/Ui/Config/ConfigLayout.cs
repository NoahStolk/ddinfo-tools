...
internal sealed class ConfigLayout(GameInstallationValidator gameInstallationValidator, INativeFileDialog nativeFileDialog, FontService fontService, UserSettings userSettings)
{
	public void Render()
	{
