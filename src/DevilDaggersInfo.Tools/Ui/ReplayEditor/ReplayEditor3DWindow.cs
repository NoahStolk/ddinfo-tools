	...
	ContentManager contentManager)
{
	...
	{
		_arenaScene = new ArenaScene(gl, resourceManager, contentManager, glfw, window, glfwInput, () => fileStates.Replay.Object.Spawnset, false, false, fileStates, spawnsetSaver, userSettings);
	}
