...
internal sealed class ModManagerState(PopupManager popupManager, ILogger logger, UserSettings userSettings)
{
	...
	public void LoadTocEntries()
	{
		...
		{
			logger.Error(ex, "Error loading mod binary '{SelectedFileName}'.", _selectedFileName);
