...
internal sealed class UserSettings(ILogger logger)
{
	...
	private readonly string _filePath = Path.Combine(_fileDirectory, "settings");
	private readonly string _imguiIniFilePath = Path.Combine(_fileDirectory, "imgui.ini");
